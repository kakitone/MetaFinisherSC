...
parser.add_argument('-th', '--threshold', help= 'Whether you need relaxed threshold (input is True)', required=False)
...
if args['threshold'] == "True":
    houseKeeper.globalRelaxThres = True
else:
    houseKeeper.globalRelaxThres = False
